...
const Contact = () => {
  ...
  const sendEmailFunction = async (e) => {
    ...
    await fetch("https://formsubmit.co/ajax/897b014b673d1192a1039dce10650abd", {
      ...
      .then(data =>
        toast.success("Sent Successfully 😀 I'll reply you as soon as possible", {
          position: "top-right",
          autoClose: 5000,
    ...
    >
      <motion.div className="textContainer" variants={variants}>
        ...
        <motion.div className="item" variants={variants}>
          <motion.div className="iconContainer">
            <SlEnvolope className="iconStyle" />
          </motion.div>
          <motion.div className="info">
            <h2><span>Mail</span></h2>
            <h4>elkarroumi.ghizlane00@gmail.com</h4>
          </motion.div>
        </motion.div>
        <motion.div className="item" variants={variants}>
          <motion.div className="iconContainer">
          ...
          <motion.div className="info">
            ...
            <h4>Where there's Wi-Fi 😄💻✨</h4>
          </motion.div>
        </motion.div>
        <motion.div className="item" variants={variants}>
          <motion.div className="iconContainer">
            <SlPhone className="iconStyle" />
          </motion.div>
          <motion.div className="info">
      ...
      <div className="formContainer">
        ...
        >
          ...
          <textarea rows={8} name="message" placeholder="Your Message" required value={message} onChange={(e) => setMessage(e.target.value)} />
